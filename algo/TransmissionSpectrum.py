...
import Laser.LaserControl as Laser
from PicoControl.PicoControl import PicoScopeControl as Scope
from PicoControl.PicoControl import PicoSigGenControl as SigGen


class TransmissionSpectrum:
    def __init__(self,directory,init_wavelength = 776e-8,final_wavelength = 781e-8,Python_Control = True):
        """"""
        if Python_Control:
            self.single_scan_width = SigGen.calculate_scan_width()
